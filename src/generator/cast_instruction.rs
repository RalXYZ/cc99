    ...
    pub fn gen_cast_llvm_instruction(&self, curr: &Ty, dest: &Ty) -> Result<Op> {
        let instruction = match curr {
            ...
            Ty::SignedInteger(IT::Int) => match dest {
                Ty::SignedInteger(IT::Char) | Ty::UnsignedInteger(IT::Char) |
                Ty::SignedInteger(IT::Short) | Ty::UnsignedInteger(IT::Short) => Op::Trunc,
            ...
            Ty::SignedInteger(IT::Long) => match dest {
                Ty::SignedInteger(IT::Char) | Ty::UnsignedInteger(IT::Char) |
                Ty::SignedInteger(IT::Short) | Ty::UnsignedInteger(IT::Short) |
                Ty::SignedInteger(IT::Int) | Ty::UnsignedInteger(IT::Int) => Op::Trunc,
